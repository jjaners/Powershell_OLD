...
{
    $Result += Get-ADUser $user -Properties samaccountname, sthlmFakturaRef, userAccountControl, distinguishedName, Enabled, givenname, surname,  HomeDirectory, HomeDrive, sthlmVerksamhetsId, sthlmForvaltningsNr, sthlmKontoTyp,`
     homeMDB, msRTCSIP-PrimaryHomeServer, employeeType, Pager, extensionAttribute13 |`
     select samaccountname, sthlmFakturaRef, userAccountControl, distinguishedName, Enabled, givenname, surname,  HomeDirectory, HomeDrive, sthlmVerksamhetsId, sthlmForvaltningsNr, sthlmKontoTyp,`
     homeMDB, msRTCSIP-PrimaryHomeServer, employeeType, Pager, extensionAttribute13
}
