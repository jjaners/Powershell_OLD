...
#$csv = Import-Csv C:\Users\xxjanerj\Documents\Stockholms_Stad\Logs\Reports\Cos_Users_Excel_Report_$date.csv -Delimiter ',' |`
$csv = Import-Csv C:\Users\xxjanerj\Documents\Stockholms_Stad\Logs\Reports\User_Mig_Excel_Report_$date.csv -Delimiter ',' |`
select Samaccountname, ADUserExists, distinguishedName, Exchange, Skype, sthlmVerksamhetsId, sthlmForvaltningsNr, sthlmKontoTyp, userAccountControl, employeeType, ScanToFile, manager, Versamhet
